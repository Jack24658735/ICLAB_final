...
## Implement Edge Detection and Object Detection on Image using HOG (Histogram of Oriented Gradient) Algorithm With Some Famous Filters</br>利用方向梯度直方圖演算法實現圖像邊緣檢測及物件識別
